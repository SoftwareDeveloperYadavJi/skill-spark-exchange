...
interface SchedulePublicMeetingProps {
    open: boolean;
    onOpenChange: (open: boolean) => void;
}

export const SchedulePublicMeeting = ({ open, onOpenChange }: SchedulePublicMeetingProps) => {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    <DialogTitle>Schedule a Public Meeting</DialogTitle>
                    <DialogDescription>
