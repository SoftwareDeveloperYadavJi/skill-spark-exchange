          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-4">
              <Button
                ...
                size="sm"
                asChild
                className={`text-foreground ${location.pathname === "/messages" ? "bg-primary hover:bg-primary text-white" : "hover:bg-primary"
                  }`}
              >
                <Link to="/messages">
              ...
              <Button
                ...
                size="sm"
                asChild
                className={`text-foreground ${location.pathname === "/connections" ? "bg-primary hover:bg-primary text-white" : "hover:bg-primary"
                  }`}
              >
                <Link to="/connections">
              ...
              <Button
                ...
                size="sm"
                asChild
                className={`text-foreground ${location.pathname === "/contact" ? "bg-primary hover:bg-primary text-white" : "hover:bg-primary"
                  }`}
              >
                <Link to="/contact">
              ...
              <Button
                ...
                size="sm"
                asChild
                className={`text-foreground ${location.pathname === "/profile" ? "bg-primary hover:bg-primary text-white" : "hover:bg-primary"
                  }`}
              >
                <Link to="/profile">
                  <User className="mr-2" />
              ...
              <Button
                ...
                size="sm"
                asChild
                className={`text-foreground ${location.pathname === "/" ? "bg-primary hover:bg-primary" : "hover:bg-primary"
                  }`}
              >
                <Link to="/">
